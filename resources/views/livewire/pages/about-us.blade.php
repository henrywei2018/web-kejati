...
<div class="container pb-5 pt-lg-5 mt-5">
    <div class="row">
                ...
                <div class="m-3">
                    ...
                    <ul class="nav nav-list nav-list-arrows flex-column mb-0">
                        ...
                        <li class="nav-item"><a href="demo-accounting-1-services-details.html" class="nav-link">Tax
                                Planning</a></li>
                        <li class="nav-item"><a href="demo-accounting-1-services-details.html" class="nav-link">Business
                                Advisory</a></li>
                        <li class="nav-item"><a href="demo-accounting-1-services-details.html" class="nav-link">Payroll
                                Management</a></li>
                        <li class="nav-item"><a href="demo-accounting-1-services-details.html" class="nav-link">Global
                                Accounting</a></li>
                        <li class="nav-item"><a href="demo-accounting-1-services-details.html" class="nav-link">Admin
                                Services</a></li>
                    </ul>
        ...
        <div class="col-lg-8">
            <p>We provide comprehensive accounting services tailored to meet the unique needs of each client. Our team
                of experienced accountants is dedicated to helping businesses of all sizes manage their financial health
            ...
            <div class="row mt-5">
                <div class="col-lg-6 mb-4 mb-lg-0 pe-lg-5">
                    ...
                    <ul class="list list-icons list-icons-lg list-icons-style-3 text-3-5">
                        ...
                        <li><i class="fas fa-check bg-color-dark-rgba-10 text-color-before-secondary"></i> Bookkeeping
                            Services</li>
                        ...
                        <li><i class="fas fa-check bg-color-dark-rgba-10 text-color-before-secondary"></i> Budgeting and
                            Forecasting</li>
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <div class="appear-animation mt-2 animated blurIn appear-animation-visible"
                        ...
                        <div class="d-flex align-items-center pt-4">
                            ...
                            <div class="p-2 ps-3">
                                <div class="animated-icon animated fadeIn svg-fill-color-primary"><svg fill="none"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        viewBox="0 5 24 14" id="icon_221725475921235" data-filename="icon-6.svg"
                                        width="48" height="48">
                        ...
                        <div class="col-lg-7">
                            <div class="appear-animation" data-appear-animation="fadeIn"
                                ...
                                <h2 class="text-9 font-weight-semibold line-height-1 mb-4"><span
                                    ...
                                    <mark
                                        class="text-dark mark mark-color mark-color-primary mark-pos-2 mark-height-100 p-0 appear-animation"
                                        data-appear-animation data-appear-animation-delay="1500">Dedication</mark></h2>
                            </div>
                            <div class="row">
                                <div class="col">
                    ...
                    <div class="accordion accordion-modern-status accordion-modern-status-arrow accordion-modern-status-arrow-dark"
                            ...
                            <div id="collapseWhyChooseUsOne" class="collapse"
                                ...
                                <div class="card-body pt-0">
                                    <p class="mb-0">Our expert team of certified accountants brings years of
                                        experience and deep industry knowledge to help you navigate complex financial
                        ...
                        <div class="card card-default box-shadow-8 border-radius-2 bg-light">
                            ...
                            <div id="collapseWhyChooseUsTwo" class="collapse"
                                ...
                                data-bs-parent="#accordionWhyChooseUs">
                                <div class="card-body pt-0">
                                    <p class="mb-0">Our personalized approach ensures your unique financial needs are
                                        met with tailored solutions. We take the time to understand your business,
                                        offering dedicated support and customized strategies to help you achieve your
                        ...
                        <div class="card card-default box-shadow-8 border-radius-2 bg-light">
                            ...
                            <div id="collapseWhyChooseUsFour" class="collapse"
                                ...
                                data-bs-parent="#accordionWhyChooseUs">
                                <div class="card-body pt-0">
                                    <p class="mb-0">Our client-centric focus means you are always our top priority.
                                        We build strong relationships by listening to your needs and providing
                                        responsive, tailored services. Your success drives our efforts, ensuring that we
                    ...
                    <div class="toggle toggle-minimal toggle-faqs toggle-dark m-0" data-plugin-toggle>
                        <section class="toggle">
                            ...
                            <div class="toggle-content">
                                <p class="mb-0">We work with a wide range of businesses, from small startups to large
                                    corporations, across various industries. Our team is equipped to handle the unique
                        ...
                        <section class="toggle">
                            ...
                            <div class="toggle-content">
                                <p class="mb-0">Our pricing is flexible and depends on the scope of work required. We
                                    offer competitive hourly rates, flat fees for specific services, and custom packages
                        ...
                        <section class="toggle">
                            ...
                            <div class="toggle-content">
                                <p class="mb-0">We use industry-leading software like QuickBooks, Xero, and Sage, but
                        ...
                        <section class="toggle">
                            <a class="toggle-title text-4 text-dark">Can you help with tax planning and
                                preparation?</a>
                            <div class="toggle-content">
                                <p class="mb-0">Yes, we provide comprehensive tax services, including tax planning,
                                    preparation, and filing. Our goal is to help you minimize your tax liabilities while
                        ...
                        <section class="toggle">
                            ...
                            <div class="toggle-content">
                                <p class="mb-0">The frequency of reporting is up to you. We can provide monthly,
                                    quarterly, or annual reports, depending on your needs. Regular communication ensures
                        ...
                        <section class="toggle">
                            ...
                            <div class="toggle-content">
                                <p class="mb-0">Absolutely. We provide full-service bookkeeping, including
                                    transaction recording, bank reconciliations, payroll processing, and more, to keep
                        ...
                        <section class="toggle">
                            ...
                            <div class="toggle-content">
                                <p class="mb-0">Our firm is distinguished by our personalized approach, deep industry
                        ...
                        <section class="toggle">
                            ...
                            <div class="toggle-content">
                                <p class="mb-0">Yes, we offer strategic financial planning services, including
                                    forecasting, budgeting, and cash flow analysis, to help you make informed decisions
