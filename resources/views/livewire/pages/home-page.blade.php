<div>
                                    ...
                                    <div class="col-lg-5 text-center text-lg-start px-4">
                                        <h4 class="text-5 text-lg-6 font-weight-medium mb-4 appear-animation"
                                            ...
                                            <img width="29" height="29"
                                                src="img/demos/accounting-1/icons/icon-7.svg"
                                                class="w-auto d-inline-flex p-relative bottom-2" alt="">
                                            Streamline
                                            Your Finances
                                        </h4>
                                    ...
                                    <div class="col-8 col-lg-7 mt-3 px-md-5 ps-xl-5 pe-xxl-0 mt-lg-0">
                                        <div class="p-relative">
                                            <div class="custom-mask-img custom-mask-img-1">
                                                <img class="img-fluid"
                                                    src="img/demos/accounting-1/generic/generic-1.jpg" loading="lazy"
                                                    alt="">
                                            </div>
                                            ...
                                            <div class="p-absolute bg-dark custom-stamp-1 appear-animation"
                                                ...
                                                <div class="rotate-animation">
                                                    <svg viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <text font-size="20" fill="#FFF" letter-spacing="0"
                                                            ...
                                                            <textPath xlink:href="#curvedText1">GLOBAL ACCOUNTING
                                                                COMPANY -
                                                ...
                                                <div class="p-absolute transform3dxy-n50 left-50pct top-50pct">
                                                    <img width="58" height="58"
                                                        src="img/demos/accounting-1/icons/icon-shape-1.svg"
                                                        alt="" data-icon
                                ...
                                <div class="col-lg-6 text-center">
                                    ...
                                    <div class="appear-animation" data-appear-animation="fadeInUpShorter"
                                        ...
                                        <h4 class="text-6 text-lg-7 text-color-light font-weight-regular mb-4"><span
                                                class="d-inline-flex p-relative top-7"><img width="34"
                                                    height="34" src="img/demos/accounting-1/icons/icon-7.svg"
                                                    data-icon
                                    ...
                                    <div class="appear-animation" data-appear-animation="fadeInUpShorter"
                                        data-appear-animation-delay="600">
                                        <h2
                                            class="text-10 text-lg-12 font-weight-semibold text-color-light line-height-1">
                    ...
                    <span class="thumb-info thumb-info-no-overlay thumb-info-show-hidden-content-hover">
                        <span
                            ...
                            <a href="demo-accounting-1-services-details.html" title="">
                                <img src="img/demos/accounting-1/services/service-1.jpg" loading="lazy"
                                    class="img-fluid" alt="">
                            </a>
                        </span>
                ...
                <div class="box-shadow-7 border-radius-2 overflow-hidden">
                    <span class="thumb-info thumb-info-no-overlay thumb-info-show-hidden-content-hover">
                        <span
                            class="thumb-info-wrapper overlay overlay-show overlay-gradient-bottom-content border-radius-0 rounded-top">
                            <a href="demo-accounting-1-services-details.html" title="">
                                <img src="img/demos/accounting-1/services/service-2.jpg" loading="lazy"
                                    class="img-fluid" alt="">
                            </a>
                        </span>
                        <span class="thumb-info-content">
                ...
                <div class="box-shadow-7 border-radius-2 overflow-hidden">
                    <span class="thumb-info thumb-info-no-overlay thumb-info-show-hidden-content-hover">
                        <span
                            class="thumb-info-wrapper overlay overlay-show overlay-gradient-bottom-content border-radius-0 rounded-top">
                            <a href="demo-accounting-1-services-details.html" title="">
                                <img src="img/demos/accounting-1/services/service-3.jpg" loading="lazy"
                                    class="img-fluid" alt="">
                            </a>
                        </span>
                        <span class="thumb-info-content">
                ...
                <div class="box-shadow-7 border-radius-2 overflow-hidden">
                    <span class="thumb-info thumb-info-no-overlay thumb-info-show-hidden-content-hover">
                        <span
                            class="thumb-info-wrapper overlay overlay-show overlay-gradient-bottom-content border-radius-0 rounded-top">
                            <a href="demo-accounting-1-services-details.html" title="">
                                <img src="img/demos/accounting-1/services/service-4.jpg" loading="lazy"
                                    class="img-fluid" alt="">
                            </a>
                        </span>
                        <span class="thumb-info-content">
                ...
                <div class="box-shadow-7 border-radius-2 overflow-hidden">
                    <span class="thumb-info thumb-info-no-overlay thumb-info-show-hidden-content-hover">
                        <span
                            class="thumb-info-wrapper overlay overlay-show overlay-gradient-bottom-content border-radius-0 rounded-top">
                            <a href="demo-accounting-1-services-details.html" title="">
                                <img src="img/demos/accounting-1/services/service-5.jpg" loading="lazy"
                                    class="img-fluid" alt="">
                            </a>
                        </span>
                        <span class="thumb-info-content">
                ...
                <div class="box-shadow-7 border-radius-2 overflow-hidden">
                    <span class="thumb-info thumb-info-no-overlay thumb-info-show-hidden-content-hover">
                        <span
                            class="thumb-info-wrapper overlay overlay-show overlay-gradient-bottom-content border-radius-0 rounded-top">
                            <a href="demo-accounting-1-services-details.html" title="">
                                <img src="img/demos/accounting-1/services/service-6.jpg" loading="lazy"
                                    class="img-fluid" alt="">
                            </a>
                        </span>
                        <span class="thumb-info-content">
                    ...
                    <article id="article-content"
                        ...
                        <div class="thumb-info-wrapper thumb-info-wrapper-opacity-1 position-relative"
                            ...
                            <img id="article-image" src="{{ asset('img/default-blog-image.jpg') }}" class="img-fluid"
                                style="height: 100%; width: auto;" alt="Default Title">
                            <div
        ...
        <div class="row">
            <div class="col-lg-8 p-4">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="large-image-frame">
                                                <a href="{{ route('infographic.show', $firstInfographic['slug']) }}">
                                                ...
                                                <div class="item-footer">
                                                    @if (!empty($item['file_url']))
                                                        <a href="{{ $item['file_url'] }}" target="_blank"
                                                            ...
                                                            wire:click="trackMediaDownload({{ $item['id'] }})">
                                                            @if ($item['is_pdf'])
                                                                Download
                                                            @else
                                                                View
                ...
                <div class="heading heading-border heading-middle-border mt-3 pt-6">
                    <h3 class="text-4">
                        <strong
                            class="font-weight-bold rounded-3 text-1 px-3 text-light py-2 bg-primary">Pengumuman</strong>
                    </h3>
                </div>
                <div class="row pb-1">
                    <div class="col">
            ...
            <div class="col-lg-4 order-2 order-lg-0 mt-4 mt-lg-0">
                ...
                <div class="bg-primary text-light p-4 border-radius-2 mb-4">
                    <div class="m-3">
    ...
    <!-- Our Teams -->
    <div class="bg-primary px-xl-0 py-8 border-radius-2 text-light p-relative overflow-hidden">
                    ...
                    <div class="appear-animation" data-appear-animation="fadeInRightShorter"
                        ...
                        <span
                            class="badge bg-gradient-tertiary-dark text-light rounded-pill text-uppercase font-weight-semibold text-2-5 px-3 py-2 px-4 mb-4"><span
                                class="d-inline-flex py-1 px-2">Pegawai</span></span>
                    </div>
                    <div class="appear-animation" data-appear-animation="fadeInUpShorter"
